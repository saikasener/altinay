...
# --------------------------------------------------------------------------------------------------
    ...
    def runDemo(self, TrajType=None):
        ...
        global emg_from_c_plc_sub, scanner_area_sub, scanner_area_pub, scanner_status_pub, moobot_sensor_status_sub_s_plc, rate
...
def MotorInit(self):
    ...
    self.processImage.variables.RightMotor.RxPDO_Mapping_3.Profile_acceleration.set(300)
...
# -------------------------------------------------------------------------------------------------
    ...
    self.processImage.variables.LeftMotor.RxPDO_Mapping_3.Profile_acceleration.set(300)
