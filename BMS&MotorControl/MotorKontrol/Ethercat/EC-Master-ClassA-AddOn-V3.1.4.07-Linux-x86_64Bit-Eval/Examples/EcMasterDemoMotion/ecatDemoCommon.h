...
{
    EC_T_DWORD                dwInstanceId;         /**< [in] Master instance */
...
const EC_T_CHAR* SlaveVendorText(T_eEtherCAT_Vendor EV);
const EC_T_CHAR* SlaveProdCodeText(T_eEtherCAT_Vendor EV, T_eEtherCAT_ProductCode EPC);
