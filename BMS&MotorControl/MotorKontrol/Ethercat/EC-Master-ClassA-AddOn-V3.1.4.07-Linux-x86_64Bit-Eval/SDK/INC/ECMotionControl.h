...
typedef EC_T_DWORD (*EcatCoeSdoDownloadFptr)(
...
typedef EC_T_DWORD  (*EcatCoeSdoUploadFptr)(
     EC_T_DWORD     dwSlaveId       /* [in]  slave ID */
    ,EC_T_WORD      wObIndex        /* [in]  SDO index */
    ,EC_T_BYTE      byObSubIndex    /* [in]  SDO sub-index */
...
typedef EC_T_DWORD (*EcatSoeWriteFptr)(
...
typedef  EC_T_DWORD (*EcatSoeReadFptr)(
    EC_T_DWORD  dwSlaveId         /**< [in]  ethercat slave ID */
   ,EC_T_BYTE   byDriveNo         /**< [in]  number of drive in slave */
...
typedef EC_T_DWORD  (*EcatGetSlaveStateFptr)(
    EC_T_DWORD              dwSlaveId       /**< [in]   slave id */
...
#if (defined EC_MOTION_TRAJECTORY_GEN) && (defined ECMOTIONLIB_BUILD)
...
public:
    ...
    MC_CAM_IN_T(MC_T_AXIS_REF *pMasterAxis = MC_NULL, MC_T_AXIS_REF *pSlaveAxisParm = MC_NULL)
        : // Init from constructor
