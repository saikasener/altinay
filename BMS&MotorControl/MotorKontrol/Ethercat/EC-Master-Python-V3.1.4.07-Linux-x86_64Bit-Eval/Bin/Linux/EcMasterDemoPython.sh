#!/bin/bash
# ----------------------------------------------------------------------------
# EcMasterDemoPython.sh
# ----------------------------------------------------------------------------
# Start EC-Master demo for Python
# ----------------------------------------------------------------------------
# --mode 1
...
python3 ../../Examples/EcMasterDemoPython/EcDemoApp.py --mode 1 -b 4000 -t 0 -v 3 --link "sockraw eth0 1" -f ENI.xml
