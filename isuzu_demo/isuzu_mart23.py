#!/usr/bin/env python3
'''
ISUZU -> 2 istasyon arası yük alıp bırakma senaryosu (yüksüz hareket yok)
...
KAMYON_ALANI = 5  # lift down
# CIKIS_KAMYON = 6  
KAMYON_ALANI_DOLLY2  = 6   # KAMYON_ALANI İLE AYNI # liftup 
GIRIS_DOLLY_2 = 7
DOLLY_2= 8 # lift down 
# CIKIS_DOLLY_2 =10 # GIRIS_DOLLY_1 ile aynı 
...
KAMYON_ALANI_DOLLY2_WAIT = 77
GIRIS_DOLLY_2_WAIT = 78
DOLLY_2_WAIT = 79
CIKIS_DOLLY_2_WAIT = 80
...
for station in stations:
    ...
    #     stations_list.append(new_station)
        ...
        new_station = Station(GIRIS_DOLLY_2,
                              station_x, station_y, station_z)
        stations_list.append(new_station)
    elif number == 8:
        new_station = Station(DOLLY_2,
                              station_x, station_y, station_z)
        stations_list.append(new_station)
...
# 1. İSTASYON (HOME)-> GİRİŞ DOLLY 1 İLE AYNI 
                ...
                print("Senaryo başlangıç --> Footprint (--) - Scanner Area(1) - Tolerance (0.05) ")
                msg.data = 1
...
# 3. İSTASYONA - dolly_load
                ...
                print("DOLLY_1'a girmek için 1 saniye bekleniyor...")
                time.sleep(1.0)
...
# 4. İSTASYONA - giriş (2 ile aynı)
                ...
                print("CIKIS_DOLLY_1'a gitme için 3 saniye bekleniyor... Footprint ++  & & Scanner (0.5)")
...
# 6. İSTASYONA - KAMYON ALANI DOLLY BIRAKMA ALANI
                ...
                print("KAMYON_ALANI'a gitme için 0.5 saniye bekleniyor... Tolerance-> 0.05 ")
                time.sleep(0.5)
...
# 7. İSTASYONA giriş2 (5 ile aynı)
                ...
                print("KAMYON_ALANI_DOLLY2'a gitme için 4 saniye bekleniyor...")          
                time.sleep(4.0)
                ...
                if lift_status_val != LIFT_UP:
                    ...
                    time.sleep(1.0)
                    if goal_sended == False:
                        current_pos = GIRIS_DOLLY_2_WAIT
# 2. İSTASYON - giriş1
            elif current_pos == GIRIS_DOLLY_2_WAIT:  # homeda bekliyor
                print("GIRIS_DOLLY_1'a gitme için 0 saniye bekleniyor...")
                time.sleep(4.0)
                current_pos = GIRIS_DOLLY_2_GO

            elif current_pos == GIRIS_DOLLY_2_GO:
                if goal_sended == False:
                    next_station = GIRIS_DOLLY_2
                    thread_send_station = Thread(
                        target=send_station, args=[next_station, current_pos], daemon=True)
                    thread_send_station.start()

            elif current_pos == GIRIS_DOLLY_2:
                if goal_sended == False:
                    current_pos = DOLLY_2_WAIT


# 6. İSTASYONA - KAMYON ALANI DOLLY BIRAKMA ALANI
            elif current_pos == DOLLY_2_WAIT:
                print("DOLLY_2'a gitme için 1 saniye bekleniyor...")
                time.sleep(0.5)
                current_pos = DOLLY_2_GO

            elif current_pos == DOLLY_2_GO:
                if goal_sended == False:
                    next_station = DOLLY_2
                    thread_send_station = Thread(
                        target=send_station, args=[next_station, current_pos], daemon=True)
                    thread_send_station.start()

            elif current_pos == DOLLY_2:
                print("DOLLY_2'a geldim. ")
                if goal_sended == False:
                ...
                if lift_status_val != LIFT_DOWN:
                    ...
                    time.sleep(1.0)
                    if goal_sended == False:
                        current_pos = CIKIS_DOLLY_2_WAIT                        

            elif current_pos == CIKIS_DOLLY_2_WAIT:
                print("DOLLY_1'a gitme için 1 saniye bekleniyor...")        
                time.sleep(4.0)
                current_pos = DOLLY_1

            # elif current_pos == CIKIS_DOLLY_2_GO:
            #     if goal_sended == False:
            #         next_station = CIKIS_DOLLY_2
            #         thread_send_station = Thread(
            #             target=send_station, args=[next_station, current_pos], daemon=True)
            #         thread_send_station.start()

            # elif current_pos == CIKIS_DOLLY_2:
            #     print("CIKIS_DOLLY_2'a geldim. Doli tekrar yüklenmek üzere bekleniyor")
            #     if goal_sended == False:
            #         current_pos = HOME
