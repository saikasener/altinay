...
#                TrVel += 1
                RMR = WheelVelocity(self,AgvLinearVel,AgvAngVel,Rdir) # RightMotorRpm
...
# --------------------------------------------------------------------------------------------------
def WheelVelocity(self,LinVel,AngVel,Rdir):
...
def GetVelActual(self):
    return self.processImage.variables.RightMotor.TxPDO_Mapping_1.Velocity_actual_value.get()
# --------------------------------------------------------------------------------------------------
#def FaultView(self):
#    self.processImage.variables.RightMotor.RxPDO_Mapping_1.Controlword.set(15)
# --------------------------------------------------------------------------------------------------
...
## --------------------------------------------------------------------------------------------------
#def WheelVelocity(self,TrajVel):
#    self.processImage.variables.RightMotor.RxPDO_Mapping_1.Target_velocity.set(TrajVel)
#    self.processImage.variables.LeftMotor.RxPDO_Mapping_1.Target_velocity.set(TrajVel)
## --------------------------------------------------------------------------------------------------
#def WheelStart(self):    
