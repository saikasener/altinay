...
public:
  explicit SwitchButton(QWidget* parent = NULL, Style style =ONOFF);
...
public:
  explicit SwitchBackground(QWidget* parent = NULL, QColor color = QColor(154, 205, 50), bool rect = false);
...
public:
  explicit SwitchCircle(QWidget* parent = NULL, QColor color = QColor(255, 255, 255), bool rect = false);
