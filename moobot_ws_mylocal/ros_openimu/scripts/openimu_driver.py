...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        if packetType == 'z1':
            ...
            imu_msg.header.frame_id = frame_id
            imu_msg.header.seq = seq
            imu_msg.orientation.x = np.sin(readback[2]/2) * np.cos(readback[3]/2) * np.cos(readback[4]/2) - np.cos(readback[2]/2) * np.sin(readback[3]/2) * np.sin(readback[4]/2)
            imu_msg.orientation.y = np.cos(readback[2]/2) * np.sin(readback[3]/2) * np.cos(readback[4]/2) + np.sin(readback[2]/2) * np.cos(readback[3]/2) * np.sin(readback[4]/2)
            imu_msg.orientation.z = np.cos(readback[2]/2) * np.cos(readback[3]/2) * np.sin(readback[4]/2) - np.sin(readback[2]/2) * np.sin(readback[3]/2) * np.cos(readback[4]/2)
            imu_msg.orientation.w = np.cos(readback[2]/2) * np.cos(readback[3]/2) * np.cos(readback[4]/2) + np.sin(readback[2]/2) * np.sin(readback[3]/2) * np.sin(readback[4]/2)
            imu_msg.orientation_covariance[0] = -1
